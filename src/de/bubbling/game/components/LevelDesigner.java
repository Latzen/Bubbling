...
public class LevelDesigner {
    ...
    private static int RED = Color.rgb(255, 23, 56), BROWN = Color.rgb(77, 44, 44), LIGHT_ORANGE = Color.rgb(255, 255, 0);
    ...
    public LevelDesigner(DifficultyProperties.Difficulty difficulty) {
        ...
        switch (difficulty) {
            ...
            case hard:
                ...
                levelOne.addStage(new Stage(15000, Stage.THREE_ENTITIES, 2.2, 1.1, 1280, levelOne.stages(), RED, GREEN, BLUE, LIGHT_ORANGE, GOLD,BROWN));
                levelOne.addStage(new Stage(20000, Stage.THREE_ENTITIES, 2.2, 1.1, 1280, levelOne.stages(), RED, GREEN, BLUE, PURPLE, LIGHT_ORANGE, GOLD));
                ...
                levelOne.addStage(new Stage(44000, Stage.FIVE_ENTITIES, 3.2, 2.2, 2250, levelOne.stages(), RED, GREEN, BLUE, PURPLE, PINK, LIGHT_ORANGE, GOLD));
                ...
                levelOne.addStage(new Stage(60000, Stage.SIX_ENTITIES, 3.7, 2.8, 2750, levelOne.stages(), RED, GREEN, BLUE, PURPLE, PINK, LIGHT_ORANGE, YELLOW, GOLD));
                level.add(levelOne);

                Level two  = new Level(new Scene(R.drawable.backgroundgray, LEVEL_TWO), Level.UsedTypes.Triangle,  levelID++);
                two.addStage(new Stage(65000, Stage.THREE_ENTITIES, 2.4, 1.1, 1280, two.stages(), RED, GREEN, BLUE));
                two.addStage(new Stage(72000, Stage.THREE_ENTITIES, 2.4, 1.1, 1280, two.stages(), RED, GREEN, BLUE,BROWN));
                two.addStage(new Stage(82000, Stage.FOUR_ENTITIES, 2.7, 1.7, 1750, two.stages(),RED, GREEN,BLUE, PURPLE, LIGHT_ORANGE, GOLD));
                two.addStage(new Stage(90000, Stage.FIVE_ENTITIES, 3.2, 2.2, 2250, two.stages(),RED, GREEN,BLUE, PURPLE, LIGHT_ORANGE, GOLD,YELLOW,BROWN));
                level.add(two);

                Level three  = new Level(new Scene(R.drawable.backgroundgray, LEVEL_THREE), Level.UsedTypes.TriangleBubbles,  levelID++);
                three.addStage(new Stage(95000, Stage.THREE_ENTITIES, 2.4, 1.1, 1280, three.stages(), RED, GREEN, BLUE,BROWN));
                ...
                three.addStage(new Stage(115000, Stage.FOUR_ENTITIES, 2.9, 1.8, 1750, three.stages(),RED, GREEN,BLUE, PURPLE, LIGHT_ORANGE, GOLD,BROWN));
                ...
                three.addStage(new Stage(150000, Stage.SIX_ENTITIES, 3.7, 2.8, 2750, three.stages(),RED, GREEN,BLUE, PURPLE, LIGHT_ORANGE, GOLD,YELLOW,PINK ));
                level.add(three);

                Level four  = new Level(new Scene(R.drawable.backgroundgray, LEVEL_FOUR), Level.UsedTypes.TriangleBubblesRectangle,  levelID++);
                four.addStage(new Stage(160000, Stage.THREE_ENTITIES, 2.4, 1.1, 1280, four.stages(), RED, GREEN, BLUE,BROWN));
                ...
                four.addStage(new Stage(178000, Stage.FOUR_ENTITIES, 2.9, 1.8, 1750, four.stages(),RED, GREEN,BLUE, PURPLE, LIGHT_ORANGE, GOLD,BROWN));
                ...
                four.addStage(new Stage(190000, Stage.FIVE_ENTITIES, 3.3, 2.3, 2250, four.stages(),RED, GREEN,BLUE, PURPLE, LIGHT_ORANGE, GOLD,YELLOW,PINK ));
                ...
                //highscore block
                suddenDeath.addStage(new Stage(300000, Stage.SIX_ENTITIES, 3.7, 0.0, 2750, four.stages(),RED, GREEN,BLUE, PURPLE, LIGHT_ORANGE, GOLD,YELLOW,PINK,BROWN ));
