...
public class LevelDesigner {
    ...
    private static int RED = Color.rgb(200, 0, 0), LightSeaGreen = Color.rgb(154, 255, 154), LIGHT_ORANGE = Color.rgb(255, 255, 0);
    private static int PURPLE = Color.rgb(160, 032, 240), BLUE = Color.rgb(30, 144, 255), PINK = Color.rgb(255, 20, 147);
    private static int GREEN = Color.rgb(0, 139, 0), GOLD = Color.rgb(255, 185, 15), YELLOW = Color.rgb(255, 255, 0);
